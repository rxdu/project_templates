...
typedef struct HW_XVR_3231S{
	...
	union{
		...
		WO struct{
			...
			//force on the first stage buffer of PA
			...
			//enable the faster settling of vbg to VCO ldo
			...
			uint32 PAHqEn:1;
			//Enable cross MOS to enahace Q of balun
			uint32 PAvbnSel:3;
			//PA nMOS bias voltage selection
			uint32 PAvbpSel:3;
			//PA pMOS bias voltage selection
			uint32 gPAspi:5;
			//Controlling gain of PA, from -20dBm pout to +4dBm
			uint32 gPAdspEn:1;
